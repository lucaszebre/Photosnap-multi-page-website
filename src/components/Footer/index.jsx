        ...
        <div className="FooterContainer">
            <div className="FooterWrapper">
                ...
                <ul className="FooterList">
                    <Link onClick={scrollToTop} className="FooterLink"to={"/"}>
                        <li className="FooterItems">HOME</li>
                    </Link>
                    <Link onClick={scrollToTop} className="FooterLink" to={"/stories"}>
                        <li className="FooterItems">STORIES</li>
                    </Link>
                    <Link onClick={scrollToTop}  className="FooterLink" to={"/features"}>
                        <li className="FooterItems">FEATURES</li>
                    </Link>
                    <Link onClick={scrollToTop}  className="FooterLink" to={"/pricing"}>
                        <li className="FooterItems">PRICING</li>
                    </Link>
                </ul>

                <div className="FooterBlock3">
                    <div className="FooterRow">
                        <div className="FooterText">GET AN INVITE</div>
                        <Arrow />
                    </div>
                    <p className="FooterCopyright">
                        Copyright © 2021 Photosnap. All rights reserved.
                        </p>  
                </div>
            </div>
        </div>
